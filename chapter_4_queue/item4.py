...
if score >= 7 : print("Yes! You're my love! : Score is {0}.".format(score))                      #  สมมุติ >> " คะแนน {0} , integer {2} , string {1} ".format(score,str,int) -> {ตำแหน่ง} แด้ว
elif score > 0 : print("Umm.. It's complicated relationship! : Score is",str(score)+".")         # ใช้ + จะไม่เว้นบรรทัด ถ้าใช้ , จะเว้น
